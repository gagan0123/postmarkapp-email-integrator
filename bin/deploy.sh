...
# main config
export PLUGINSLUG="postmarkapp-email-integrator"  #must match with wordpress.org plugin slug
export MAINFILE="postmarkapp.php" # this should be the name of your main php file in the wordpress plugin
